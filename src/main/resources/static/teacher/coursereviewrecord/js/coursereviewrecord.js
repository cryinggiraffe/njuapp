...
var vm = new Vue({
    ...
    methods: {
        ...
        findAllCourseReviewRecords(){
            this.loadings();
            this.$http.post('/coursereviewrecord/findAllCourseReviewRecords',
                {
                    cId: this.cId
                }).then(result => {
                console.log(result);
        ...
        handleEdit(id) {
            ...
            this.editor = {}; //清空表单
            //查询当前id对应的数据
            this.$http.post('/coursereviewrecord/findByCrId',
                {
                    crId: id
                }).then(result => {
        ...
        sureEdit(editor) {
            ...
            console.log(this.editor)
            //调用更新数据的接口
            this.$http.post('/coursereviewrecord/updateResult', {
